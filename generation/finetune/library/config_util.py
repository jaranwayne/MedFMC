...
def add_config_arguments(parser: argparse.ArgumentParser):
  parser.add_argument("--dataset_config", type=Path, default=None, help="config file for detail settings")
...
class ConfigSanitizer:
  ...
  def __init__(self, support_dreambooth: bool, support_finetuning: bool, support_controlnet: bool, support_dropout: bool) -> None:
    assert support_dreambooth or support_finetuning or support_controlnet, "Neither DreamBooth mode nor fine tuning mode specified. Please specify one mode or more."
    ...
    if support_dreambooth and support_finetuning:
      def validate_flex_dataset(dataset_config: dict):
        ...
        # NOTE: all DB subsets should have no "metadata_file"
          ...
          raise voluptuous.Invalid("DreamBooth subset and fine tuning subset cannot be mixed in the same dataset. Please split them into separate datasets. ")
