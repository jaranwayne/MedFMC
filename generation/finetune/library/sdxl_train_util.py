...
def verify_sdxl_training_args(args: argparse.Namespace, supportTextEncoderCaching: bool = True):
    ...
    if args.v_parameterization:
        print("v_parameterization will be unexpected ")

    if args.clip_skip is not None:
        print("clip_skip will be unexpected ")

    if args.multires_noise_iterations:
        print(
            f"Warning: SDXL has been trained with noise_offset={DEFAULT_NOISE_OFFSET}, but noise_offset is disabled due to multires_noise_iterationsF"
        )
    else:
