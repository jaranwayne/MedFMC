...
def main(args):
    ...
    assert len(max_reso) == 2, f"illegal resolution (not 'width,height')"
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("model_name_or_path", type=str, help="model name or path to encode latents ")
    ...
    parser.add_argument(
        "--flip_aug", action="store_true", help="flip augmentation, save latents for flipped images "
    )
    parser.add_argument(
        "--skip_existing",
        action="store_true",
