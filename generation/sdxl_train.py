...
def train(args):
    ...
    assert not args.weighted_captions, "weighted_captions is not supported currently "
    assert (
    ...
    if args.save_model_as is None:
        ...
        assert save_stable_diffusion_format, "save_model_as must be ckpt or safetensors "
    ...
    if args.max_train_epochs is not None:
        ...
        accelerator.print(f"override steps. steps for {args.max_train_epochs} epochs is")
...
def setup_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--diffusers_xformers", action="store_true", help="use xformers by diffusers")
