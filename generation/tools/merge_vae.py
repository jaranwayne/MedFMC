...
if __name__ == "__main__":
  ...
  parser.add_argument("ckpt", type=str, help="target checkpoint to replace VAE ")
  parser.add_argument("vae", type=str, help="VAE/model checkpoint to merge")
  parser.add_argument("output", type=str, help="output checkoint ")
